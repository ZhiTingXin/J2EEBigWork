...
@Controller
@RequestMapping(value = "InstitutionBookedInfo")
public class InstitutionBookedInfoController {
    @Autowired
    ...
    public String getPage(Model model, @RequestParam("Institution")String ins){
        ...
        for(int i=0;i<courses.size();i++){
            ...
            for (int i1=0;i1<courseOrders.size();i1++){
                if(courseOrders.get(i1).getOrderState().equals("已预订")){
